            ...
            <div className="row"  onClick={this.stopPropagation.bind(this)}  onMouseDown={this.stopPropagation.bind(this)}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-10 pt-2">
                            <RangeSlider start={this.props.filters.runtime.min} end={this.props.filters.runtime.max}
                                         min="20" max="240" step="1" rangeType="runtime"
                ...
                <div className="col-12 pb-5 pt-3">
                    <div className="row">
                        ...
                        <div className="col-10 pt-4">
                            <RangeSlider start={this.props.filters.rottentomatoes.min}
                                         end={this.props.filters.rottentomatoes.max}
                                         min="0" max="100" step="1" rangeType="rottentomatoes"
                                         range={this.props.filters.rottentomatoes}
